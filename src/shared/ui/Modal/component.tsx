	...
	useEffect(() => {
		const inertAll = (isOpen: boolean, isUnmounted = false) => {
			...
			for (const el of document.body.children) {
				if (el !== modalRef.current && el instanceof HTMLElement)
					el.inert = isOpen;
			}
		};
		inertAll(isOpen);
