  ...
  return (
    <article className={classNames(styles.default, className)}>
      ...
      >
        ...
        <svg className={styles.arrow} width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {isActive && (
        <ul className={styles.options}>
          {options.map((option) => (
            <li key={option}>
              <Button
                className={classNames(styles.option, { [styles.selected]: option === value })}
