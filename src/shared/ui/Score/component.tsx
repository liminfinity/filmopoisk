    ...
    >
      {Array.from({ length }, (_, i) => {
        ...
        return (
          <label 
            key={currentScore}
            onMouseEnter={() => onHoverChange && onHoverChange(currentScore)}
          >
            <input
